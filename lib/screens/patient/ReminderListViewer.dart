...
class ReminderListViewer extends StatefulWidget {
  static const String id = 'patient_viewer';
  final String title;
  ReminderListViewer({Key key, @required this.title}) : super(key: key);
  @override
  _ReminderListViewerState createState() => _ReminderListViewerState(title);
}

class _ReminderListViewerState extends State<ReminderListViewer> {
  StateModel appState;
  String title;
  _ReminderListViewerState(this.title);
  var cron = new Cron();
