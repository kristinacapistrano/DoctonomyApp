...
class ReminderViewer extends StatefulWidget {
  static const String id = 'patient_home';

  _ReminderViewerState createState() => _ReminderViewerState();
}

class _ReminderViewerState extends State<ReminderViewer> {
  StateModel appState;
  String title = "";
  @override
  void initState() {
                      ...
                      child: ListView(
                        children: <Widget>[
                          ...
                          Builder(builder: (BuildContext context) {
                            var allergyList = snapshot.data["reminders"]?.toList() ?? [];
